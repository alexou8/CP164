...
class List:
    ...
    def _intersection_r_aux(self, node_source1, source2):
        """
        -------------------------------------------------------
        ...
        if node_source1 is not None:
            value = node_source1._value
            _, current, _ = source2._linear_search(value)
            if current is not None:
                _, current, _ = self._linear_search(value)
                if current is None:
            ...
            self._intersection_r_aux(node_source1._next, source2)
    ...
    def _append_list(self, source):
        """
        -------------------------------------------------------
        Appends all nodes from source to self and clears source.
        -------------------------------------------------------
        Parameters:
            source
        Returns:
