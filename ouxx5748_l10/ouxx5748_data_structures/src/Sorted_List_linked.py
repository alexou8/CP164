...
class Sorted_List:
    ...
    def union(self, source1, source2):
        ...
        while source1_node is not None or source2_node is not None:
            if source1_node is not None and (source2_node is None or source1_node._value < source2_node._value):
                new_value = source1_node._value
                source1_node = source1_node._next
            elif source2_node is not None and (source1_node is None or source2_node._value < source1_node._value):
    ...
    def _move_front_to_rear(self, source):
        """
        -------------------------------------------------------
        Moves the front node of the source list to the rear of the current list.
