...
print()
print("count of each item in lst3: ")
print(f"Name                                Count")
print(f"---------------------------------   -----")
for value in lst3:
...
print()
print("count of each item in lst2: ")
print(f"Name                                Count")
print(f"---------------------------------   -----")
for value in lst2:
...
print()
print("count of each item in target1: ")
print(f"Name                                Count")
print(f"---------------------------------   -----")
...
print()
print("count of each item in target2: ")
print(f"Name                                Count")
print(f"---------------------------------   -----")
...
print()
print("count of each item in target3: ")
print(f"Name                                Count")
print(f"---------------------------------   -----")
...
print()
print("count of each item in target4: ")
print(f"Name                                Count")
print(f"---------------------------------   -----")
