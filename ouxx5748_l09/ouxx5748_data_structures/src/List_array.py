...
class List:
    ...
    def _linear_search(self, key):
        ...
        while index < len(self._values) and next:
    ...
    def intersection(self, source1, source2):
        ...
        for val in source1._values:
            if val in source2._values and val not in self._values:
    ...
    def max(self):
        ...
        for curr_value in self._values:
            if curr_value > value:
                value = deepcopy(curr_value)
