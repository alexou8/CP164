...
class _SL_Node:
    def __init__(self, value, next_node=None):
        """
        -------------------------------------------------------
        Initializes a sorted linked list node.
        -------------------------------------------------------
        Parameters:
            value - the value to store in the node (?)
            next_node - the next node in the list (_SL_Node)
        Returns:
            None
        -------------------------------------------------------
        """
...
class Sorted_List:
    ...
    def clean(self):
        ...
        if len(self._values) > 1:
            cleaned = [self._values[0]]
            for i in range(1, len(self._values)):
                if self._values[i] != self._values[i - 1]:
                    cleaned.append(self._values[i])
    ...
    def count(self, key):
        ...
        if i != -1:
            checkL = i
            checkR = i
            while checkL >= 0 and self._values[checkL] == key:
                number += 1
                checkL -= 1
            checkR += 1
            while checkR < len(self._values) and self._values[checkR] == key:
                number += 1
                checkR += 1
    ...
    def split_key(self, key):
        ...
        if len(self._values) > 0:
            if key < self._values[0]:
                ...
                if i == -1:
                    i = 0
                    while i < len(self._values) and key > self._values[i]:
                        i += 1
